...
const CompareQuotes = () => {
  ...
  console.log("selectedQuoteIndex1", selectedQuoteIndex1);
  console.log("selectedQuoteIndex2", selectedQuoteIndex2);
    ...
    return [
      {
        key: "adults",
        field: "Adults",
        quote1: data.passengers?.adults ?? 0,
        quote2: quote1.passengers?.adults ?? 0,
      },
      {
        key: "childrenUnder5",
        field: "Children Under 5",
        quote1: data.passengers?.childrenUnder5 ?? 0,
        quote2: quote1.passengers?.childrenUnder5 ?? 0,
      },
      {
        key: "childrenUnder11",
        field: "Children Under 11",
        quote1: data.passengers?.childrenUnder11 ?? 0,
        quote2: quote1.passengers?.childrenUnder11 ?? 0,
      },
      {
        key: "total",
        field: "Total Passengers",
        quote1: data.passengers?.total ?? 0,
        quote2: quote1.passengers?.total ?? 0,
      },
    ];
  };
    ...
    return [
      {
        key: "selectedRoom",
        field: "Selected Room",
        quote1: data.accommodation.selectedRoom,
        quote2: quote1.accommodation.selectedRoom,
      },
      {
        key: "onePersonRooms",
        field: "One Person Rooms",
        quote1: data.accommodation.onePersonRooms,
        quote2: quote1.accommodation.onePersonRooms,
      },
      {
        key: "twoPersonRooms",
        field: "Two Person Rooms",
        quote1: data.accommodation.twoPersonRooms,
        quote2: quote1.accommodation.twoPersonRooms,
      },
      {
        key: "threePersonRooms",
        field: "Three Person Rooms",
        quote1: data.accommodation.threePersonRooms,
        quote2: quote1.accommodation.threePersonRooms,
      },
    ];
  };
    ...
    return [
      {
        key: "totalPrice",
        field: "Total Price",
        quote1: `$${data.totalPrice}`,
        quote2: `$${quote1.totalPrice}`,
      },
      {
        key: "utilizationRate",
        field: "Utilization Rate",
        quote1: `${data.utilizationRate}%`,
        quote2: `${quote1.utilizationRate}%`,
      },
    ];
  };
      ...
      >
       ...
       <Collapse defaultActiveKey={["1", "2", "3", "4", "5"]}>
        ...
        >
          <Table
            ...
            dataSource={generateTableData(
              quotes[selectedQuoteIndex1],
              quotes[selectedQuoteIndex2]
            )}
            bordered
            pagination={false}
            style={tableStyle}
        ...
        >
          <Table
            columns={columns}
            dataSource={generateAccommodationData(
              quotes[selectedQuoteIndex1],
              quotes[selectedQuoteIndex2]
            )}
            bordered
        ...
        >
          <Table
            columns={columns}
            dataSource={generateVehiclesData(
              quotes[selectedQuoteIndex1],
              quotes[selectedQuoteIndex2]
            )}
            bordered
        ...
        >
          <Table
            columns={columns}
            dataSource={generateServicesData(
              quotes[selectedQuoteIndex1],
              quotes[selectedQuoteIndex2]
            )}
            bordered
       ...
       <Panel
        ...
        >
          <Table
            columns={columns}
            dataSource={generateSummaryData(
              quotes[selectedQuoteIndex1],
              quotes[selectedQuoteIndex2]
            )}
            bordered
