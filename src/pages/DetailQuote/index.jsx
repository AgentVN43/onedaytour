...
import { Card, Row, Col, Table, Tag, Divider, Form, Input, InputNumber, DatePicker, Button, Checkbox } from 'antd';
import { CalendarOutlined, CarOutlined, UnorderedListOutlined, HomeOutlined } from '@ant-design/icons';
...
const DetailQuotes = ({ onSave }) => {
    ...
    console.log("🚀 ~ DetailQuotes ~ mealData:", mealData)
    useEffect(() => {
        ...
        <div style={{ padding: '20px' }}>
            <Card title={`Quote Detail - ${quoteDetails.quoteId}`} bordered={false}>
                ...
                >
                    <Row gutter={24}>
                        <Col span={12}>
                            <Card title="Passenger Information" bordered={false}>
                                ...
                                <Form.Item label="Children (under 5)" name={["passengers", "childrenUnder5"]}>
                                    <InputNumber disabled={!isEditable} />
                                </Form.Item>
                                <Form.Item label="Children (under 11)" name={["passengers", "childrenUnder11"]}>
                                    <InputNumber disabled={!isEditable} />
                                </Form.Item>
                                <Form.Item label="Total Passengers" name={["passengers", "total"]}>
                        ...
                        <Col span={12}>
                            <Card title="Accommodation" bordered={false}>
                                <Form.Item label="Selected Room ID" name={["accommodation", "selectedRoom"]}>
                                    <Input disabled={!isEditable} />
                                </Form.Item>
                                <Form.Item label="1-Person Rooms" name={["accommodation", "onePersonRooms"]}>
                                    <InputNumber disabled={!isEditable} />
                                </Form.Item>
                                <Form.Item label="2-Person Rooms" name={["accommodation", "twoPersonRooms"]}>
                                    <InputNumber disabled={!isEditable} />
                                </Form.Item>
                                <Form.Item label="3-Person Rooms" name={["accommodation", "threePersonRooms"]}>
                                    <InputNumber disabled={!isEditable} />
                                </Form.Item>
                            </Card>
                        </Col>
                    ...
                    <Button onClick={toggleEdit} type="default" style={{ marginLeft: '10px' }}>
